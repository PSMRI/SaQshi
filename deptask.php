...
<div class="pcoded-main-container">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        // ================================================
                        //  Check how many departments are active for this facility (for rule: fac_id=8)
                        // ================================================
    ...
    ");
                        ...
                        $isSingleDeptFacility = ($factype == 8);
                        ?>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['activate_department_id'])) {
                            ...
                            // If facility type 8 already has one active department → block activation
...
================================================= -->
                        ...
                        <div class="table-responsive mt-2">
                            ...
                            <table class="table table-bordered table-hover table-striped table-sm mb-0" style="width:100%;">
        ...
        ";
                ...
                WHERE fac_id = ? AND acc_id = ? AND fac_dept_id = ?
            ");
                                        $checkQuery->bind_param("iii", $facilityId, $assessmentPeriod, $deptId);
                                        $checkQuery->execute();
                    ...
                    <form method='POST' style='display:inline;'>
                        ...
                        <button class='btn btn-sm btn-danger me-1'>Disable</button>
                    </form>
                    <span class='btn btn-sm btn-success disabled'>Activated</span>
                ";
                                        } else {

                                            if ($isSingleDeptFacility && $activeCount >= 1) {
                                                echo "<button class='btn btn-sm btn-secondary disabled'>Activate</button>";
                                            } else {
                                                echo "
                        <form method='POST' style='display:inline;'>
