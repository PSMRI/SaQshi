...
<form method="POST" action="#">
  ...
  <div class="card shadow-sm border rounded p-3 bg-light bg-gradient small">
    <h5 class="text-center mb-4 fw-bold text-primary">
      <i class="bi bi-clipboard2-check-fill me-2 text-success"></i>
      Checklist Details for Compliance
    </h5>
      ...
      <div class="col-md-3 col-xl-4">
        <div class="card bg-white shadow-sm h-100">
          <div class="card-body p-2">
           ...
           <strong> <div class="text-dark text-break"><?php echo $row['c_subtype_Reference_No_fk'] ?? ''; ?></div></strong>
          </div>
    ...
    <div class="card bg-white shadow-sm mb-3">
      <div class="card-body p-2">
        ...
        <div class="text-dark text-break"><?php echo $row['M'] ?? ''; ?></div>
      </div>
    </div>
    </div>
</div>
      ...
      <div class="col-md-6 col-xl-4">
        <div class="card bg-white shadow-sm h-100">
          <div class="card-body p-2">
            ...
            <div class="text-dark text-break"><?php echo $row['C'] ?? ''; ?></div>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-xl-4">
    ...
    <div class="card bg-white shadow-sm mb-3">
      <div class="card-body p-2">
        ...
        <div class="text-dark text-break"><?php echo $row['Means'] ?? ''; ?></div>
      </div>
    </div>
    <div class="card bg-white shadow-sm mb-3 border-top border-3 border-info">
      ...
      <input type="hidden" name="csqa_id" value="<?php echo $row['csqa_id'] ?? ''; ?>">
      <input type="hidden" name="csqa_id2" value="<?php echo $row['c_subtype_id_fk'] ?? ''; ?>">

      <!-- Buttons as Cards -->
      <div class="d-flex justify-content-center gap-4 mt-4 flex-wrap">
        <div class="card shadow-sm border-0">
          <div class="card-body p-2 text-center">
            <button type="submit" name="edit" value="<?php echo $row['csqa_id']; ?>" class="btn btn-warning btn-sm w-100">
              <i class="bi bi-arrow-left-circle me-1"></i>Back & Update
            </button>
          </div>
        </div>
        <div class="card shadow-sm border-0">
          <div class="card-body p-2 text-center">
            <button type="submit" name="postsubmit1" class="btn btn-primary btn-sm w-100">
              <i class="bi bi-arrow-right-circle me-1"></i>Save & Next
            </button>
          </div>
        </div>
      </div>
