        ...
        function calculateResult(rowIndex) {
            var numerator = document.getElementById('input' + (rowIndex * 2 - 1)).value;
            var denominator = document.getElementById('input' + (rowIndex * 2)).value;
    
            if (denominator != 0) {
                var result = (numerator / denominator) * 100; // Calculate percentage
                document.getElementById('result' + rowIndex).value = result.toFixed(2) + "%"; // Display as percentage
            } else {
                document.getElementById('result' + rowIndex).value = "N/A"; // Avoid division by zero
            }
        }
...
var currentDate = new Date();
        ...
        switch (row) {
            ...
            case 3:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    result =numerator*100; // Example calculation
                ...
                break;
                case 11:
                numerator = parseFloat(document.getElementById('input20').value);
                denominator = parseFloat(document.getElementById('input21').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    result =((numerator*100)/(denominator)); // Example calculation
                ...
                break;
                case 12:
                numerator = parseFloat(document.getElementById('input22').value);
                denominator = parseFloat(document.getElementById('input23').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    result =((numerator*100)/(denominator)); // Example calculation
                ...
                break;
                case 13:
                numerator = parseFloat(document.getElementById('input24').value);
                denominator = parseFloat(document.getElementById('input25').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                ...
                break;
                case 15:
                numerator = parseFloat(document.getElementById('input28').value);
                denominator = parseFloat(document.getElementById('input29').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    result =((numerator*100)/(denominator)); // Example calculation
                ...
                break;
                case 16:
                numerator = parseFloat(document.getElementById('input30').value);
                denominator = parseFloat(document.getElementById('input31').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    result =((numerator*100)/(denominator)); // Example calculation
