    ...
    switch (row) {
        case 1:
           ...
           denominator = parseFloat(document.getElementById('input2').value);
            if  (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0){
                result = (((numerator) / (denominator*dayOfMonth))*100); // Example calculation
        ...
        case 20:
           ...
           denominator = parseFloat(document.getElementById('input42').value);
            ...
            break ;
              case 22:
            let input43 = document.getElementById('input43').value.trim().toLowerCase();
            if (input43 === 'yes') {
                document.getElementById('result22').value = '100.00%';
            } else if (input43 === 'no') {
                document.getElementById('result22').value = '0.00%';
            } else {
                document.getElementById('result22').value = 'Invalid input';
            }
            break;

        // Yes/No field – input45
        case 23:
            let input45 = document.getElementById('input45').value.trim().toLowerCase();
            if (input45 === 'yes') {
                document.getElementById('result23').value = '100.00%';
            } else if (input45 === 'no') {
