...
function calculateResult(row) {
    ...
    switch (row) {
        ...
        case 2:
            ...
            if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                result = ((numerator) / (denominator)*100);//ple calculation
        ...
        case 4:
          ...
          //denominator = parseFloat(document.getElementById('input8').value);
            if (!isNaN(numerator) ) {
                result = ((numeratorr));// Example calculation
        ...
        case 5:
            ...
            if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                result = ((numerator / denominator)*100);//ample calculation
        ...
        case 8:
           ...
           //enominator = parseFloat(document.getElementById('input16').value);
            if (!isNaN(numerator)) {
        ...
        case 9:
            ...
            if (!isNaN(numerator) ) {
                result = (numerator/denominator);//xample calculation
        ...
        case 10:
            ...
            if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                result = ((numerator / denominator))*100;//mple calculation
        ...
        case 12:
           ...
           //enominator = parseFloat(document.getElementById('input24').value);
            if (!isNaN(numerator)) {
                result = (numerator ); // Example calculation
