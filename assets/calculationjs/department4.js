        ...
        switch (row) {
            case 1:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result1').value = 'Invalide';
                }
                break;
            ...
            case 2:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result2').value = 'Invalide';
                }
                break;
            ...
            case 3:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result3').value = 'Invalide';
                }
                break;
                case 4:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result4').value = 'Invalide';
                }
                break;
                case 5:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result5').value = 'Invalide';
                }
                break;
                case 6:
               ...
               denominator = parseFloat(document.getElementById('input12').value);
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result6').value = 'Invalide';
                }
                break;
                case 7:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result7').value = 'Invalide';
                }
                break;
                case 8:
                ...
                if (!isNaN(numerator)) {
                    ...
                    document.getElementById('result8').value = 'Invalide';
                }
                break;
                case 9:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result9').value = 'Invalide';
                }
                break;
                case 10:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result10').value = 'Invalide';
                }
                break;
                case 11:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result11').value = 'Invalide';
                }
                break;
                case 12:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result12').value = 'Invalide';
                }
                break;
                case 13:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result13').value = 'Invalide';
                }
                break;
                case 14:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result14').value = 'Invalide';
                }
                break;
                case 15:
               ...
               // denominator = parseFloat(document.getElementById('input30').value);
                if (!isNaN(numerator)) {
                    ...
                    document.getElementById('result15').value = 'Invalide';
                }
                break;
                case 16:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result16').value = 'Invalide';
                }
                break;
                case 17:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result17').value = 'Invalide';
                }
                break;
                case 18:
                ...
                if (!isNaN(numerator) && !isNaN(denominator) && denominator !== 0) {
                    ...
                    document.getElementById('result18').value = 'Invalide';
                }
                break;                     
