...
header('Content-Disposition: attachment; filename="Block_level_Facility_KPI_Outcome_Summary.csv"');
echo "\xEF\xBB\xBF";
...
========================================================= */
$result = mysqli_query($con, "CALL generate_outcomekpi_all_block($block_id)");
if (!$result) {
