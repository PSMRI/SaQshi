...
header('Content-Disposition: attachment; filename="dist_level_Facility_actionplan_Summary.csv"');
...
$sql = "
     SELECT 
  *
    FROM action_plan_chk where fac_id in (select fac_id from facilities where dist_id=$dist_id)
";
