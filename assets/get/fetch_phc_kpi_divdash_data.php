...
header('Content-Disposition: attachment; filename="Dist_level_Facility_KPI_Outcome_Summary.csv"');
echo "\xEF\xBB\xBF";
...
$dist_id= intval( $_SESSION['div_id']);
/* =========================================================
   EXECUTE STORED PROCEDURE
========================================================= */
$result = mysqli_query($con, "CALL generate_outcomekpi_all_div($dist_id)");
if (!$result) {
