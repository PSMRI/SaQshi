...
header('Content-Disposition: attachment; filename="Block_level_Facility_actionplan_Summary.csv"');
...
$block_id = intval($_SESSION['block_id']);
// SQL query
$sql = "
     SELECT 
  *
    FROM action_plan_chk where fac_id in (select fac_id from facilities where block_id=$block_id)
";
