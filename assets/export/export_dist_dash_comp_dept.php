...
if (isset($_GET['facid']) && isset($_GET['deptid'])  && isset($_GET['accid'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $fileName = $facilityName . "_dept_Compliance_Report_" . date('Y-m-d') . ".xlsx";
        ...
        $tablequery = "CALL dept_wise_indicators($facilityId, $userId, $facdept,$facacc)";
