...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $excelData[] = array('Department', 'Area of concern', 'Reference No', 'Sub Reference No', 'Measurable Element', 'Checkpoint', 'Assessment Method', 'Means of Verification', 'Compliance','PendingAtDist.');

        // Fetch records from database using stored procedure
        $tablequery = "CALL dist_dash_pdist_reports($facilityId)";
