        ...
        <div class="pcoded-content">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    // Fetch facility data
                    $.getJSON('assets/get/get_cert_data_div1.php', function(facilities) {
...
WHERE fac_id <> 13061 and division_id=$dist_id
";
...
AND v.ass_period_id = latest.latest_ass and v.division_id=$dist_id
";
